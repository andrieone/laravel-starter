...
@section('breadcrumbs')
    <ol class="breadcrumb float-sm-right">
        ...
        <li class="breadcrumb-item"><a href="{{route('admin.company.user.index', $parent_id)}}">@lang('label.user')</a></li>
...
@section('top_buttons')
    @if ($page_type == "create")
        <a href="{{route('admin.company.user.index', $parent_id)}}" class="btn btn-info float-sm-right">@lang('label.list')</a>
    @else
        <a href="{{route('admin.company.user.create', $parent_id)}}" class="btn btn-info float-sm-right">@lang('label.createNew')</a>
        <a href="{{route('admin.company.user.index', $parent_id)}}" class="btn btn-info float-sm-right">@lang('label.list')</a>
    @endif
@endsection
