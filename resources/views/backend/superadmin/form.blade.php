                    ...
                    <div class="card">
                        ...
                        <div class="card-header">
                            <div class="row mb-2">
                                ...
                                <div class="col-sm-12 col-sm-6">
                                    @if ($page_type == "create")
                                        <a href="{{route('admin.super-admin.index')}}" class="btn btn-info float-sm-right">@lang('label.list')</a>
                                    @else
                                        <a href="{{route('admin.super-admin.create')}}" class="btn btn-info float-sm-right">@lang('label.createNew')</a>
                                    @endif
                                </div>
                            </div>
                        </div>
...
@section('js')
    <script>
        ...
        $('li#superadmins').find('.nav-treeview').find('#list_superadmin a').removeClass('active');
    </script>
@endsection
